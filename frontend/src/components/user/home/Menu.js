...
function Menu() {
  ...
  return (
    ...
    spacing={3}>
    <div>
    <IconButton size='large' sx={{ boxShadow: 5 }} style={{backgroundColor:"white"}} onClick={()=>createATicket("incident")}>
      <ReportProblemIcon style={{color:"#00101F"}}/>
    </IconButton>
    <Link to="/create-ticket?tag=incident" style={{paddingLeft:20,fontFamily:"Yantramanav",fontSize:"100%",color:"#00101F",textDecoration:"none" }}>Prijavi problem</Link>
    </div>
    <div>
    <IconButton onClick={()=>createATicket("req")} size='large' sx={{ boxShadow: 5 }} style={{backgroundColor:"white"}}>
      <FeedbackIcon style={{color:"#00101F"}}/>
    </IconButton>
    <Link to="/create-ticket?tag=req" style={{paddingLeft:20,fontFamily:"Yantramanav",fontSize:"100%",color:"#00101F",textDecoration:"none" }}>Podnesi zahtjev za uslugom</Link>
    </div>
    <div>
